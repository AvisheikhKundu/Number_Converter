...
label1:
    ...
    printf("Enter the number & Hit ENTER Button: ");
    scanf("%d", &choice);
...
void exitScreen()
{
    screenCleaner();
    printf("-------------------------------------------\n");
    printf("          Creator:Avisheikh Kundu          \n");
    printf("-------------------------------------------\n\n");

    printf("> GitHub: https://github.com/AvisheikhKundu \n");
    printf("> LinkedIn: https://www.linkedin.com/in/avisheikhkundu/ \n\n");
